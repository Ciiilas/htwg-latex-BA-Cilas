...
Der Parser wurde so erweitert, das er die Möglichkeit hat, versteckte Tests zu erkennen. Die Erweiterung, des in \ref{lst:koanExampleWithoutHiddenTests} gezeigten Koans, kann in dem Listing \ref{lst:koanExampleWithHiddenTests} gesehen werden. Sämtliche Koans müssen lediglich um einen \texttt{//hiddentest} und \texttt{//enhiddentest} Block erweitert werden und können ohne weiter Anpassung des Parsers verarbeitet werden.
